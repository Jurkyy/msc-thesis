...
class OneCycleLR(Callback):
    ...
    def on_train_begin(self, logs={}):
        ...
        if self.params.keys().__contains__('batch_size'):
            self.batch_size = self.params['batch_size']

        if self.params.keys().__contains__('samples'):
        ...
        self._reset()
        K.set_value(self.model.optimizer.learning_rate, self.compute_lr())
...
class LRFinder(Callback):
    ...
    def on_train_begin(self, logs=None):
        ...
        K.set_value(self.model.optimizer.learning_rate, self.initial_lr)
